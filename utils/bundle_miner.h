 ...
 * @param[in]   fully_secure          Whether to check if the bundle hash is fully secure even outside of our desired
                                      security level
...
retcode_t bundle_miner_mine(byte_t const *const bundle_normalized_max, uint8_t const security,
                            ...
                            uint8_t const nprocs, uint32_t mining_threshold, bool const fully_secure,
