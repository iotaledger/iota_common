...
def map_generate(key_type, value_type, additional_include_path = "", additional_deps = [], parent_directory = "utils/containers"):
    ...
    _map_generator(
        ...
        source = source,
        source_template = "@org_iota_common//utils/containers:map.c.tpl",
        header = header,
        header_template = "@org_iota_common//utils/containers:map.h.tpl",
        key_type = key_type,
    ...
    native.cc_library(
        ...
        deps = [
            ...
            "@org_iota_common//common/trinary:trits",
