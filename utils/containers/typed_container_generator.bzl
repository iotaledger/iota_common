...
def typed_container_generate(container_type, value_type, additional_include_path = "", additional_deps = "@org_iota_common//utils/containers:dummy_dep", parent_directory = "utils/containers"):
    ...
    _type_container_generator(
        ...
        source = source,
        source_template = "@org_iota_common//utils/containers:" + container_type + ".c.tpl",
        header = header,
        header_template = "@org_iota_common//utils/containers:" + container_type + ".h.tpl",
