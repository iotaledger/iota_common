...
public class Interface {
    ...
    public static native long bundle_miner_mine(byte[] bundle_normalized_max, int security, byte[] essence, int essence_length, int count, int nprocs, int mining_threshold, boolean fully_secure);
}
